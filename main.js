...
const firebaseConfig = {
  apiKey: "AIzaSyCflqAKEmi1blKHVfLMz0KleZ8m0OXn_v8",
  authDomain: "first-project-87863.firebaseapp.com",
  projectId: "first-project-87863",
  storageBucket: "first-project-87863.appspot.com",
  messagingSenderId: "626492012409",
  appId: "1:626492012409:web:312d10b42f376c0512e1a8",
  measurementId: "G-HH5N6CF00Z"
};
...
onAuthStateChanged(auth, (user) => {
  if (user) {
    ...
    loggedOutPage.style.display = 'block';
...
add_todo_btn.addEventListener('click', async function addTodoToDb(){
  try {
...
async function addToDisplay(){
  ...
  querySnapshot.forEach((doc) => {
    ...
    list.innerHTML += `<li>${doc.data().todo}</li>`
  });
}
...
const container = document.querySelector('.-m-4');

for (let i = 0; i < products.length; i++){
  let listedProducts = `
  <div class="lg:w-1/4 md:w-1/2 p-4 w-full box">
  <a class="block relative h-48 rounded overflow-hidden">
          <img alt="ecommerce" class="object-contain object-center w-full h-full block" src="${products[i].image}">
          </a>
      <div class="mt-4">
